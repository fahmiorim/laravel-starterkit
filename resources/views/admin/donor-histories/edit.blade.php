...
@section('title', 'Ubah Riwayat Donor')

@section('content')
<div class="p-6 space-y-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Ubah Riwayat Donor</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">Perbarui informasi kehadiran donor terpilih.</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow p-6">
        <form action="{{ route('admin.donor-histories.update', $donorHistory) }}" method="POST">
            @method('PUT')
